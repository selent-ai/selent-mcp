...
class SelentApiTools:
    ...
    def _register_tools(self) -> None:
        """Register the Selent service tools with the MCP server"""
        self.mcp.tool()(self.selent_backup)
        self.mcp.tool()(self.selent_get_backup_status)
        self.mcp.tool()(self.selent_restore)
    ...
    def selent_get_backup_status(self, backup_id: str) -> str:
        """
    ...
    def selent_get_restore_status(self, restore_id: str) -> str:
        """
        ...
        if current_status == "RUNNING":
            ...
            for comp in components:
                ...
                interpretation["component_status"].append(f"{comp_name}: {comp_status}")
    ...
    def selent_get_compliance_types(self) -> str | dict[str, Any]:
        """
    ...
    def selent_run_compliance_check(
        ...
        result = self.selent_client.run_compliance_check(compliance_type, network_id)
